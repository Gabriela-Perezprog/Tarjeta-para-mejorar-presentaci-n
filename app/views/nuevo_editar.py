...
# el valor de initial puede ser de tipo dictionary o None (sino recibe nada se asigna None)
def formulario_nuevo_editar_producto(page: ft.Page, on_submit, initial: dict | None = None):
    ...
    # run_task sirve para ejecutar funciones asíncronas
    # lambda es para crear un tipo de función anónima esta función lambda recibe a la variable e
